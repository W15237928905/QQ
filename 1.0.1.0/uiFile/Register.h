...
private slots:
    ...
    void on_clos_Btn_clicked();         //关闭界面函数
    void on_register_Btn_clicked();     //立即注册函数
    void on_headimg_Btn_clicked();      //选择头像函数
    bool getEdit_InputSecure();         //检测用户输入是否合理
    bool initRegister_Boundary();       //初始化界面
};
